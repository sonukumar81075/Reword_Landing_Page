      ...
      <div className="relative z-10 mx-auto w-full max-w-screen-2xl px-4 sm:px-6 md:px-12 lg:px-24">
        <div className="grid w-full grid-cols-1 items-center gap-10 md:gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="group relative">
            <div className="absolute -inset-4 rounded-2xl bg-gradient-to-tr from-sky-100 to-cyan-50 opacity-50 blur-3xl transition-opacity group-hover:opacity-70" />
            <div className="relative rounded-2xl border border-outline-variant/10 bg-surface-container-lowest p-4 shadow-[0_20px_40px_rgba(12,74,110,0.06)] sm:p-6 lg:p-8">
              ...
              <div className="absolute -bottom-5 left-3 flex items-center gap-2 rounded-xl bg-white px-3 py-2 shadow-xl sm:-bottom-6 sm:-left-6 sm:gap-3 sm:p-4">
